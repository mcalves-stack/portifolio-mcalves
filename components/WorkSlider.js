...
const WorkSlider = () => {
  return (
    <Swiper
      ...
      modules={[Pagination]} // Note that modules should be an array
                ...
                return (
                  <div className='relative rounded-lg overflow-hidden flex items-center justify-center group'>
                    <div className='flex items-center justify-center relative overflow-hidden group' key={index}>
                      ...
                      {/* overlay gradient */}
                      <div className='absolute inset-0 bg-gradient-to-l from-transparent via-[#e838cc] to-[#4a22db] opacity-0 group-hover:opacity-80
